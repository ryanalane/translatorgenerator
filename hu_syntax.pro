...
hu_np(np_node(Det_node, N_node), NP_Fstruct)  --> det(Det_node, Det_Fstruct),
...
hu_vp(vp_node(v_node(V_node)), VP_Fstruct) --> v(V_node, VP_Fstruct).
...
hu_det(det_node(D_word), D_Fstruct) --> [D_word], { hu_lex(hu_det, D_word, D_Fstruct) }.
